  ...
  render() {
    return (
      <div className="About">
        ...
        <h1 className="hi"> My name is Monica. I am a full-stack developer from Oakland. I speak Javascript (NodeJS, ExpressJS, ReactJS), I test my code (MochaJS, ChaiJS), and I know how to use a database (PostgreSQL, MongoDB).</h1>
